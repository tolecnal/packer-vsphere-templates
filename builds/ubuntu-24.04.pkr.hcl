...
source "vsphere-iso" "ubuntu-24-04" {
  ...
  vm_name       = local.ubuntu_24_04.vm_name
  guest_os_type = local.ubuntu_24_04.guest_os_type
  ...
  iso_url      = local.ubuntu_24_04.iso_url
  iso_checksum = local.ubuntu_24_04.iso_checksum
  
  http_directory = "configs"
  
  boot_wait    = local.common_vm_settings.boot_wait
  boot_command = local.ubuntu_24_04.boot_command
...
build {
  ...
  sources = ["source.vsphere-iso.ubuntu-24-04"]
