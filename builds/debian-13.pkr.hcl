...
source "vsphere-iso" "debian-13" {
  ...
  vm_name       = local.debian_13.vm_name
  guest_os_type = local.debian_13.guest_os_type
  ...
  iso_url      = local.debian_13.iso_url
  iso_checksum = local.debian_13.iso_checksum
  
  http_directory = "configs"
  
  boot_wait    = local.common_vm_settings.boot_wait
  boot_command = local.debian_13.boot_command
...
build {
  ...
  sources = ["source.vsphere-iso.debian-13"]
