...
source "vsphere-iso" "ubuntu-22-04" {
  ...
  vm_name       = local.ubuntu_22_04.vm_name
  guest_os_type = local.ubuntu_22_04.guest_os_type
  ...
  iso_url      = local.ubuntu_22_04.iso_url
  iso_checksum = local.ubuntu_22_04.iso_checksum
  
  http_directory = "configs"
  
  boot_wait    = local.common_vm_settings.boot_wait
  boot_command = local.ubuntu_22_04.boot_command
